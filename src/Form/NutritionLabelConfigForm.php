...
class NutritionLabelConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if (!$nutrition_label_path) {
      ...
      $this->messenger()->addError($this->t('The library could not be detected. You need to download the @nutrition_label and extract the entire contents of the archive into the %path directory on your server.',
